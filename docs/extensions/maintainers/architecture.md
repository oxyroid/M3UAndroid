...
| SDK distribution | Publish the API, Android protocol, typed SDK, conformance library, sources, and golden fixtures without host modules; compile Hello from those coordinates | [`verifyExtensionSdkBundle`](../../../build.gradle.kts), [`hello-extension`](../../../samples/hello-extension), [`verify-extension-sdk-distribution.sh`](../../../testing/bin/verify-extension-sdk-distribution.sh) |
