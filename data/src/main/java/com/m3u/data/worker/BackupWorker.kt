...
class BackupWorker @AssistedInject constructor(
    ...
    private fun createNotification(): Notification {
        return NotificationCompat.Builder(context, CHANNEL_ID)
            ...
            .setContentTitle(context.getString(string.data_worker_backup_content_title))
            .build()
    }
    ...
    private fun createChannel() {
        ...
        val channel = NotificationChannel(
            CHANNEL_ID,
            context.getString(string.data_worker_backup_channel_name),
            NotificationManager.IMPORTANCE_LOW
        )
        channel.description = context.getString(string.data_worker_backup_channel_description)
